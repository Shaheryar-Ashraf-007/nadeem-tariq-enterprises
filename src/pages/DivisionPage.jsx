...
export default function DivisionPage() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Hero */}
      <section
  className="relative lg:h-[300px] sm:h-[350px]  bg-cover bg-center"
  style={{
...
>
  ...
  <div className="relative z-10 flex h-full flex-col items-center justify-center text-white px-6">
    ...
    <p className="mt-4 max-w-3xl text-center lg:text-lg sm:text-xl tracking-wide font-body">
      {division.tagline}
    </p>
  </div>
</section>
      {/* Summary */}
      <section className="">
        <div className="mt-12 lg:px-28 sm:px-6">
          <p className="text-center md:text-2xl sm:text-xl font-body tracking-wide">
            {division.summary}
          </p>
        </div>
      </section>
      ...
      <section className="bg-[#ffff] py-14 font-body tracking-wide">
        <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-3 gap-8">
          ...
          {division.stats.map((item) => (
            ...
            >
              <h3 className="lg:text-4xl sm:text-5xl font-bold text-green-600">
                {item.value}
              </h3>
      ...
      <section className="max-w-7xl mx-auto px-6 font-body tracking-wide">
        ...
        <div className="flex items-center gap-3 mb-10">
          ...
          <h2 className="lg:text-3xl sm: text-4xl font-bold font-body tracking-wide">
            Product Lines
          </h2>
        </div>
  ...
  {division.lines.map((line) => (
    <div
      key={line.title}
      className="relative lg:h-[350px] sm:h-[450px] rounded-2xl overflow-hidden group font-body tracking-wide"
      style={{
    ...
    >
      ...
      <div className="absolute bottom-0 p-8 text-white z-10">
        <h3 className="lg:text-3xl sm:text-4xl font-bold font-body tracking-wide">{line.title}</h3>

        <p className="mt-3 text-gray-200 sm:text-xl font-body tracking-wide">
          {line.desc}
        </p>
      </div>
    </div>
  ...
  <div className="max-w-7xl mx-auto px-6">
    <h2 className="lg:text-3xl sm: text-4xl font-bold mb-10">Our Process</h2>
      ...
      {division.process.map((step, index) => (
        <React.Fragment key={step}>
          <div className="flex-1 min-w-[180px] border rounded-xl p-6 bg-gray-100 dark:bg-gray-50 shadow-sm hover:shadow-lg transition">
            <span className="text-green-600 lg:text-3xl sm:text-4xl font-bold font-body tracking-wide">
              {String(index + 1).padStart(2, "0")}
            </span>

            <p className="mt-5 leading-7 text-black font-body tracking-wide text-xl">{step}</p>
          </div>
